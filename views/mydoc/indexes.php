	...
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<ul class="nav">
				...
				<li class="active"><a href="indexes.html">Indexes</a></li>
...
<div class="container">
	...
	<h1>Indexes</h1>
<?php foreach ($tables as $table_name => $infos): ?>
	<?php foreach ($infos['indexes'] as $index_name => $columns): ?>
		<?php foreach ($columns as $column_name => $info): ?>
	<a href="table_<?php echo $table_name; ?>.html"><?php echo $index_name; ?> / <?php echo $table_name.'.'.$column_name; ?></a><br />
		<?php endforeach; ?>
	<?php endforeach; ?>
<?php endforeach; ?>
